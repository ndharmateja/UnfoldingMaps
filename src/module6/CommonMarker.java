...
public abstract class CommonMarker extends SimplePointMarker {
	...
	protected boolean filterHidden = false;
	protected boolean depthHidden = false;
	protected boolean magnitudeHidden = false;
	...
	public void setFilterHidden(boolean state) {
		filterHidden = state;
	}
	
	public void setDepthHidden(boolean state) {
		depthHidden = state;
	}
	
	public void setMagnitudeHidden(boolean state) {
		magnitudeHidden = state;
	}
	
	public boolean getDepthHidden() {
		return depthHidden;
	}
	
	public boolean getMagnitudeHidden() {
		return magnitudeHidden;
	}
	...
	public void draw(PGraphics pg, float x, float y) {
		...
		if (!hidden && !filterHidden && !depthHidden && !magnitudeHidden) {
			drawMarker(pg, x, y);
			if (selected) {
				showTitle(pg, x, y);
			}
